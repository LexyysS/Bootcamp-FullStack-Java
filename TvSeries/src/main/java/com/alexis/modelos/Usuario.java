...
public class Usuario {
	...
	@Size(min=3, message="El apellido debe tener al menos tres caracteres")
	...
	public List<Serie> getMisCompras() {
		return misCompras;
	}

	public void setMisCompras(List<Serie> misCompras) {
